...
export default component$(() => {
  ...
  useVisibleTask$(() => {
    ...
    function compileShader(
      shaderSource: TEMP_ANY_TODO,
      shaderType: TEMP_ANY_TODO
    ) {
    ...
    function getAttribLocation(program: TEMP_ANY_TODO, name: TEMP_ANY_TODO) {
    ...
    function getUniformLocation(program: TEMP_ANY_TODO, name: TEMP_ANY_TODO) {
  ...
  return <canvas ref={canvasRef} width="1400" height="600" />;
});
